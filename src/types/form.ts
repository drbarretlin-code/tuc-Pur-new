...
export interface FormState {
  ...
  primaryLanguage: Language;   // V521: 頂部主語系 (主編輯區輸入)
  secondaryLanguage: Language; // V521: 底部次語系 (預覽對照區)
  bilingualCache: Record<string, string>; // V28.x: 儲存泰文輸入對應的中文翻譯
  bilingualStatus?: Record<string, 'typing' | 'pending' | 'success' | 'error' | 'cooldown'>; // V29.x: 狀態追蹤
}
