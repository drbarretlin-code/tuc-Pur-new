export const translations: Record<string, any> = {
  'zh-TW': {
    ...
    'aiTranslatingStatus': '(翻譯中...)',
    'aiTranslateError': '(AI 轉譯失敗。請在原欄位隨意新增或刪除一個空白即可重新觸發)',
    'noHints': '暫無 AI 建議',
...
如於執行流程有任何建議或疑慮之處，煩請回覆此 MAIL。`,
    ...
    'docExportPdf': '匯出 PDF',
    'docCompanyName': 'Taiwan Union Technology CO., LTD.',
    'docCompanyEnglish': '台燿科技股份有限公司',
    'docTitle': '採購規格暨驗收內容',
    'docDate': '日期：',
    'docPage': '頁次：',
    'docDept': '申購單位：',
    ...
    'bilingualSync': '雙語同步',
    'syncNow': '立即同步雙語',
    'syncingBilingual': 'AI 雙語同步中...',
    'modifiedSyncNeeded': '內容已修改 (建議同步)'
  },
  'zh-CN': {
    ...
    'aiTranslatingStatus': '(翻译中...)',
    'aiTranslateError': '(AI 翻译失败。请在原栏位随意新增或删除一个空白即可重新触发)',
    'noHints': '暂无 AI 建议',
...
17. Compensation required for facilities damaged during work.`,
    ...
    'docCompanyName': 'Taiwan Union Technology CO., LTD.',
    'docCompanyEnglish': 'Taiwan Union Technology CO., LTD.',
...
If you have any suggestions or concerns regarding the process, please reply to this MAIL.`,
  ...
  'th-TH': {
    ...
    'translating': 'กำลังซิงค์การแปล AI...',
    'aiTranslatingStatus': '(กำลังแปล...)',
    'aiTranslateError': '(การแปล AI ล้มเหลว โปรดเพิ่มหรือลบช่องว่างหนึ่งช่องในฟิลด์เดิมเพื่อลองใหม่อีกครั้ง)',
    ...
    'defaultAccordingToTuc': 'ตามข้อกำหนดของ TUCE (การจัดการผู้รับเหมา, กฎความปลอดภัย, ฯลฯ)',
    'defaultAccordingToTucShort': 'ตามข้อกำหนดของ TUCE',
    'defaultNationalRegs': 'ปฏิบัติตามกฎหมายระดับประเทศ',
    'defaultSafetyRegs': 'ตามกฎระเบียบของ TUCE',
...
17. จำเป็นต้องได้รับการชดเชยสำหรับสิ่งอำนวยความสะดวกที่ได้รับความเสียหายในระหว่างการก่อสร้าง`,
    ...
    'docCompanyName': 'Taiwan Union Technology (THAILAND) CO., LTD.',
    'docCompanyEnglish': 'Taiwan Union Technology (THAILAND) CO., LTD.',
...
หากคุณมีข้อเสนอแนะหรือข้อสงสัยเกี่ยวกับขั้นตอน โปรดตอบกลับอีเมลนี้`,
    ...
    'modelLabel': 'รุ่น:',
    'bilingualSync': 'ซิงค์สองภาษา',
    'syncNow': 'ซิงค์สองภาษาตอนนี้',
    'syncingBilingual': 'AI กำลังซิงค์สองภาษา...',
    'modifiedSyncNeeded': 'มีการแก้ไข (แนะนำให้ซิงค์)'
  }
};
